...
**Anonymity enhancements for the GL-iNet GL-E5800 (Mudi 7) 5G mobile hotspot** s dual-slot IMEI rotation, MAC/BSSID/SSID/hostname/password randomization, a two-stage SIM-swap flow, and volatile client-MAC storage, controlled from the command line, a LuCI admin page, or the device's touchscreen.
