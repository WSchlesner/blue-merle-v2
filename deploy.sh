...
ssh "$HOST" 'chmod +x /usr/bin/blue-merle'
...
ssh "$HOST" 'chmod +x /etc/init.d/blue-merle-wireless /etc/init.d/blue-merle-sim-swap /etc/init.d/blue-merle-volatile-macs \
    && rm -f /etc/rc.d/S*blue-merle-wireless /etc/rc.d/S*blue-merle-sim-swap /etc/rc.d/S*blue-merle-volatile-macs \
    && /etc/init.d/blue-merle-wireless enable && /etc/init.d/blue-merle-sim-swap enable && /etc/init.d/blue-merle-volatile-macs enable'
